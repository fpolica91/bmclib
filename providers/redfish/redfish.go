...
func (c *Conn) SetVirtualMedia(ctx context.Context, kind string, mediaURL string, username string, password string) (ok bool, err error) {
	return c.redfishwrapper.SetVirtualMedia(ctx, kind, mediaURL, username, password)
}
